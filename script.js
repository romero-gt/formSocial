...
form.addEventListener('submit', function (event) {
    ...
    if(idade < 10 || idade > 90) {
        alert("idade invalida! DEve ser entre 10 e 90 anos.")
    }

    const geracao = indentificarGeeraçao(dataNascimento.getFullYear())
...
function indentificarGeeraçao(ano) {
switch (true) {
    ...
    case ano >= 2013:
        ...
        default:
            return'Geraçao nao classificada';
}
